                    ...
                    value: function(e) {
                        ...
                        try {
                            ...
                            var f = {
                                ...
                                g = e.placeholder || "",
                                k = '<div class="vwrap"><div class="vheader item' + v.length + '">' + v.join("") + '</div><div class="vedit"><textarea class="veditor vinput" placeholder="' + g + '"></textarea></div><div class="vcontrol"><div class="col col-40 text-right"><button type="button" title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' + t.locale.ctrl.reply + '</button></div></div><div style="display:none;" class="vmark"></div></div><div class="vinfo" style="display:none;"><div class="vcount col"></div></div><ul class="vlist"></ul><div class="vempty" style="display:none;"></div><div class="vpage txt-center" ></div><div class="info"><div class="power txt-right">  <a href="https://valine.js.org" target="_blank"></a> ';
                            t.el.innerHTML = k;
